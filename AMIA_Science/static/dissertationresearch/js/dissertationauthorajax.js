$( document ).ready(function() {
    ...
    $("body").on("click", ".authorrow", function() {

        $("#inputauthors1").val($(this).data("fio"));
        $("#authoridhidden1").val($(this).data("pk" ));
        $("#disabledextrainput1").val($(this).data("subdivision"));
        $(this).parent().empty();
    });
    ...
    function displayauthorsextrarows(dataJSON, elemid) {
        ...
        for (var i = 0; i < dataJSON.length; i++) {
            var newdiv = $('<div/>', {
                class: 'ajaxrow authorrow form-control',
            });
